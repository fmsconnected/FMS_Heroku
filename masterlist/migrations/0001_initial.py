# Generated by Django 2.1.7 on 2021-03-15 15:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vleasing_status', models.CharField(blank=True, choices=[('Solved', 'Solved'), ('Transferred', 'Transferred'), ('Active', 'Active')], max_length=100, null=True)),
                ('history_id', models.AutoField(primary_key=True, serialize=False)),
                ('history_date', models.DateTimeField()),
                ('history_change_reason', models.CharField(max_length=100, null=True)),
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vehicle_status', models.CharField(blank=True, choices=[('Solved', 'Solved'), ('Transferred', 'Transferred'), ('Active', 'Active')], max_length=100, null=True)),
                ('history_id', models.AutoField(primary_key=True, serialize=False)),
                ('history_date', models.DateTimeField()),
                ('history_change_reason', models.CharField(max_length=100, null=True)),
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
