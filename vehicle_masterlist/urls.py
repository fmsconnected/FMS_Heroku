...
urlpatterns = [
	...
	path('VehicleMasterlist/Update/<int:id>', views.vehicleupdate, name='vehicle_update'),
	path('VehicleMasterlist/submit', views.VmasterlistCreate, name='vehicleMasterlist_submit'),
	# path('VehicleMasterlist/Create',views.vehicleMasterUpdate.as_view(), name='vehicle_create'),
	...
	path('VehicleMasterlist/Update/Submit/<int:pk>', views.VmasterlistUpdate,name='vehicle-update'),
