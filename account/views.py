...
def index(request):
    ...
    not_registered = Registration.objects.filter(Plate_ending=reg_months,Date_registered="None" ).count()
    registered = Registration.objects.exclude(Plate_ending=reg_months,Date_registered="None").count()
