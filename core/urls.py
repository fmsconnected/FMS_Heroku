...
from ownership import views
router.register(r'Ownership', views.ownViewSet),
...
urlpatterns = [
    ...
    path('Tire/', include('tires.urls')),
    path('Fuel-Supplier/', include('fuel_supplier_payment.urls')),
