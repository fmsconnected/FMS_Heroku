...
class monthly_report_jan_summary(APIView):
    ...
    def get(self, request, format=None):
        ...
        NTT5_F01 = Petron_pivot.objects.exclude(ChargingDepartment="NTT5-F01",sum_product_amount__isnull=True)
        FIN23_C6 = Petron_pivot.objects.exclude(ChargingDepartment="FIN23-C6",sum_product_amount__isnull=True)
        NTT5_H01 = Petron_pivot.objects.exclude(ChargingDepartment="NTT5-H01",sum_product_amount__isnull=True)
        NTT5_J01 = Petron_pivot.objects.exclude(ChargingDepartment="NTT5-J01",sum_product_amount__isnull=True)
        FIN23_C9 = Petron_pivot.objects.exclude(ChargingDepartment="FIN23-C9",sum_product_amount__isnull=True)
        NTT5_G01 = Petron_pivot.objects.exclude(ChargingDepartment="NTT5-G01",sum_product_amount__isnull=True)
        SG02_P = Petron_pivot.objects.exclude(ChargingDepartment="SG02-P",sum_product_amount__isnull=True)
        CMG2_D3 = Petron_pivot.objects.exclude(ChargingDepartment="CMG2-D3",sum_product_amount__isnull=True)
        CMG2_B2 = Petron_pivot.objects.exclude(ChargingDepartment="CMG2-B2",sum_product_amount__isnull=True)
        CMG5_G = Petron_pivot.objects.exclude(ChargingDepartment="CMG5-G",sum_product_amount__isnull=True)

        dis_NTT5_F01 = Petron_pivot.objects.exclude(ChargingDepartment="NTT5-F01",sum_disc_amount__isnull=True)
        dis_FIN23_C6 = Petron_pivot.objects.exclude(ChargingDepartment="FIN23-C6",sum_disc_amount__isnull=True)
        dis_NTT5_H01 = Petron_pivot.objects.exclude(ChargingDepartment="NTT5-H01",sum_disc_amount__isnull=True)
        dis_NTT5_J01 = Petron_pivot.objects.exclude(ChargingDepartment="NTT5-J01",sum_disc_amount__isnull=True)
        dis_FIN23_C9 = Petron_pivot.objects.exclude(ChargingDepartment="FIN23-C9",sum_disc_amount__isnull=True)
        dis_NTT5_G01 = Petron_pivot.objects.exclude(ChargingDepartment="NTT5-G01",sum_disc_amount__isnull=True)
        dis_SG02_P = Petron_pivot.objects.exclude(ChargingDepartment="SG02-P",sum_disc_amount__isnull=True)
        dis_CMG2_D3 = Petron_pivot.objects.exclude(ChargingDepartment="CMG2-D3",sum_disc_amount__isnull=True)
        dis_CMG2_B2 = Petron_pivot.objects.exclude(ChargingDepartment="CMG2-B2",sum_disc_amount__isnull=True)
        dis_CMG5_G = Petron_pivot.objects.exclude(ChargingDepartment="CMG5-G",sum_disc_amount__isnull=True)

        net_NTT5_F01 = Petron_pivot.objects.exclude(ChargingDepartment="NTT5-F01",sum_net_amount__isnull=True)
        net_FIN23_C6 = Petron_pivot.objects.exclude(ChargingDepartment="FIN23-C6",sum_net_amount__isnull=True)
        net_NTT5_H01 = Petron_pivot.objects.exclude(ChargingDepartment="NTT5-H01",sum_net_amount__isnull=True)
        net_NTT5_J01 = Petron_pivot.objects.exclude(ChargingDepartment="NTT5-J01",sum_net_amount__isnull=True)
        net_FIN23_C9 = Petron_pivot.objects.exclude(ChargingDepartment="FIN23-C9",sum_net_amount__isnull=True)
        net_NTT5_G01 = Petron_pivot.objects.exclude(ChargingDepartment="NTT5-G01",sum_net_amount__isnull=True)
        net_SG02_P = Petron_pivot.objects.exclude(ChargingDepartment="SG02-P",sum_net_amount__isnull=True)
        net_CMG2_D3 = Petron_pivot.objects.exclude(ChargingDepartment="CMG2-D3",sum_net_amount__isnull=True)
        net_CMG2_B2 = Petron_pivot.objects.exclude(ChargingDepartment="CMG2-B2",sum_net_amount__isnull=True)
        net_CMG5_G = Petron_pivot.objects.exclude(ChargingDepartment="CMG5-G",sum_net_amount__isnull=True)
