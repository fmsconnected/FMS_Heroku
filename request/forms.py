...
class carrequestform(forms.ModelForm):
	...
	class Meta:
		...
		widgets = {
			'A_Employee' : forms.TextInput(attrs={'class':'form-control', 'readonly':'true'}),
			...
			'Assignee_Company': forms.TextInput(attrs={'class':'form-control', 'readonly':'true'}),
			'Assignee_band': forms.TextInput(attrs={'class':'form-control', 'readonly':'true'}),
			'Assignee_Dept': forms.TextInput(attrs={'class':'form-control', 'readonly':'true'}),
			'Assignee_Cost': forms.TextInput(attrs={'class':'form-control', 'readonly':'true'}),
			'Assignee_Div' : forms.TextInput(attrs={'class':'form-control', 'readonly':'true'}),
			'Assignee_Loc': forms.TextInput(attrs={'class':'form-control', 'readonly':'true'}),
			'Assignee_Section': forms.TextInput(attrs={'class':'form-control', 'readonly':'true'}),
			'Assignee_Designation': forms.TextInput(attrs={'class':'form-control', 'readonly':'true'}),
